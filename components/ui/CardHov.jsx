  ...
  return (
    <>
      <div className="div h-70 w-auto md:w-110 bg-white m-auto rounded-[1em] overflow-hidden relative group p-2 z-0">
        ...
        <button className="text-[0.8em] absolute bottom-[1em] left-[1em] text-[#6C3082] group-hover:text-[white] duration-500 flex">
        ...
        <p className="text-secondary-foreground group-hover:text-white">{props.dis}</p>
      </div>
    </>
  );
}
